    ...
    <div class="add-song" v-show="showFlag" @click.stop>
      ...
      <div class="shortcut" v-show="!query">
        ...
        <div class="list-wrapper" v-if="currentIndex === 0">
          <scroll :data="playHistory" ref="playList" class="list-scroll" :refreshDelay="refreshDelay">
        ...
        <div class="list-wrapper" v-if="currentIndex === 1">
          <scroll :data="searchHistory" ref="searchList" class="list-scroll" :refreshDelay="refreshDelay">
            <div class="list-inner">
      ...
      <div class="search-result" v-show="query">
        <suggest :query="query" :zhida="showSinger" @select="selectSuggest"></suggest>
      </div>
      <top-tip ref="topTip">
        <div class="tip-title">
          <i class="icon-ok"></i>
